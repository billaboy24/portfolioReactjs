...
const about = {
  ...
  resume:
    "https://drive.google.com/file/d/1Fz_1Ank1HKBS3bDGJsZ_-BdszNppeKaz/view?usp=sharing",
  social: {
...
const projects = [
  {
    name: "Robofriends",
    description: "My first ReactJS website that have search function",
    stack: ["CSS", "HTML", "React"],
    sourceCode: "https://github.com/billaboy24/robofriendReactjs",
    livePreview: "https://robofriendsreactjs.netlify.app",
  },
  {
    name: "K-Cloud",
    description:
      "Cloud hosting website.This website is prior to my understanding of HTML and CSS and demonstrate my Frontend-Skils.",
    stack: ["HTML", "CSS", "JavaScript"],
    sourceCode: "https://github.com/billaboy24/K-Cloud",
    livePreview: "https://kcloud.netlify.app",
  },
  {
    name: "SimpleRecipe",
    description:
      "A simple recipe website to demonstrate my frontend skils and boost my understanding in Frontend devlopment",
    stack: ["CSS", "HTML", "JavaScript"],
    sourceCode: "https://github.com/billaboy24/simpleRecipe",
    livePreview: "https://simplefood.netlify.app",
  },
  {
    name: "MoviesReactJS",
    description:
  ...
  {
    name: "FoodReviewAggregator",
    description:
      "A food review aggregator application that aggregates review from various website.Webscraping was used to obtain review from various websites.",
    stack: ["CSS", "React Native", "WebScrapping", "Firebase"],
    sourceCode:
      "https://github.com/billaboy24/FoodReviewAggregatorApplicationPrototype",
    livePreview:
      "https://github.com/billaboy24/FoodReviewAggregatorApplicationPrototype",
  },
  {
